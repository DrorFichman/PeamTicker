...
public enum EventType {
    ...
    settings_view, settings_changed_color, settings_changed_grades, settings_changed_tutorial_reset, settings_changed_division_percentage, settings_changed_division_attempts, // Done
